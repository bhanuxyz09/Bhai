...
bot = telebot.TeleBot('7763849431:AAHclLhwXsRLo9p2lsAwWq-pBA-YSPDdNWc')
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 MERA BHAI 💵 ™* 𝗯𝗼𝘁 !", reply_markup=markup, parse_mode='Markdown')
    bot.send_message(
        message.chat.id,
